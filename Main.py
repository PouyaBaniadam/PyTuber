...
def youtube_screen():
    ...
    def res_getter(resolution):
        ...
        if resolution == "144p":
            ...
            real_button_144p = Button(root, image=button_144p, borderwidth=0, activebackground="#323232", bg="#323232",
            ...
            real_button_240p = Button(root, image=button_240p, borderwidth=0, activebackground="#323232", bg="#323232",
            ...
            real_button_360p = Button(root, image=button_360p, borderwidth=0, activebackground="#323232", bg="#323232",
            ...
            real_button_480p = Button(root, image=button_480p, borderwidth=0, activebackground="#323232", bg="#323232",
    ...
    link_entry = Entry(root, width=20, borderwidth=0, font=("Kristen ITC", 12), bg="#121212", foreground="white")
    link_entry.place(x=40, y=152, height=30, width=370)

    path_entry = Entry(root, width=20, borderwidth=0, font=("Kristen ITC", 12), bg="#121212", foreground="white")
